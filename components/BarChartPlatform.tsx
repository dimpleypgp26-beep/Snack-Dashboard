...
export default function BarChartPlatform({ data }: Props) {
  return (
    <ChartContainer title="Avg Product Quantity per Platform" subtitle="Average units per platform & product">
      <ResponsiveContainer width="100%" height={260}>
        <BarChart data={data} margin={{ top: 4, right: 8, left: -8, bottom: 0 }} barSize={44}>
